...
//    private final ProductService productService;
//
//    @PostMapping("/product/createEvent/{id}")
//    public String createShoppingCart(ShoppingCart shoppingCart) {
//        shoppingCartService.saveShoppingCart(shoppingCart);
...
//    }
//}
//    @GetMapping("/user/{user}/shopping_cart")
//    public String shoppingCart(@PathVariable("shopping_cart") User user, Model model, ShoppingCart shoppingCart){
...
//    public String addProduct(User user, Product product, Principal principal) throws IOException {
